...
$result = $conn->query($sql);
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<div class='scroll' style = 'position:absolute; left:600px; top:550px; background-color:white;'>
...
*/
    if($searchby=="field"){
        $sql="select * from ideas where field LIKE '$search%'";
        $result = $conn->query($sql);
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<div class='scroll' style = 'position:absolute; left:600px; top:700px; background-color:white;'>
                <font color='black'><table border='5' bordercolor='black'>
                <tr>
                    <th>UserName</th>
                    <th>application_no</th>
                  ...
                  //  echo "0 results";
                    ...
                    elseif($searchby=="category"){
                        $sql="select * from ideas where category LIKE '$search%'";
                        $result = $conn->query($sql);
